        ...
        <div class="content">
          ...
          <div class="improvement">
            ...
            ${section.issues.map(issue => `
              <div class="issue">
                <div class="original">${issue.element}</div>
                <div class="optimized">Suggestion: ${issue.suggestion}</div>
                <div class="severity">Severity: ${issue.severity}</div>
              </div>
            `).join('')}
          </div>
          `).join('')}
          ...
          <div class="keywords">
            <div class="label">Current Keywords</div>
            ${results.keywords.current.map(keyword => `<span class="keyword">${keyword}</span>`).join('')}
            
            <div class="label" style="margin-top: 15px;">Suggested Keywords</div>
            ${results.keywords.suggested.map(keyword => `<span class="keyword">${keyword}</span>`).join('')}
          </div>
